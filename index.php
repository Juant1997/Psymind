...
<html lang="es">
  <head>
    ...
    <meta
      name="description"
      content="Psymind es un blog moderno sobre mente humana, conciencia, emociones, energía, percepción y misterio interior."
    />
    <meta
      name="keywords"
      content="mente humana, conciencia, emociones, universo, energía, percepción, autoconocimiento, filosofía"
    />
    <meta name="theme-color" content="#050814" />
    <meta
      property="og:title"
      content="Psymind | Blog de mente, conciencia y misterio"
    />
    <meta
      property="og:description"
      content="Una experiencia digital inmersiva dedicada al descubrimiento de la mente y el universo interior."
    />
    <meta property="og:type" content="website" />
    <meta property="og:image" content="assets/img/hero-illustration.svg" />
    <title>Psymind | Blog de mente, conciencia y misterio</title>
  ...
  <body>
    ...
    <main>
      <section class="hero-section position-relative">
        ...
        <div class="container position-relative" data-parallax>
          <div class="row align-items-center g-5">
            <div class="col-lg-7 reveal">
              <span class="hero-badge mb-3"
                ><i class="bi bi-stars"></i> Descubrimiento mental y
                espiritual</span
              >
              <h1 class="hero-title mb-4">
                Un blog para mirar la mente como si fuera un universo vivo.
              </h1>
              <p class="hero-lead mb-4">
                Psymind reúne curiosidades sobre emociones, conciencia, energía,
                percepción y el misterio de ser humanos en un lenguaje íntimo,
                moderno y reflexivo.
              </p>
            ...
            <div class="col-lg-5 reveal">
              <div
                class="hero-card p-3 p-md-4 position-relative overflow-hidden"
              >
                <div class="hero-glow"></div>
                <img
                  src="assets/img/la_mano_de_Dios.jpg"
                  alt="Ilustración abstracta de mente y cosmos"
                  class="img-fluid rounded-4 img-dios"
                />
                <div class="floating-chip top">
                  <i class="bi bi-brilliance text-primary"></i> ideas que flotan
                </div>
                <div class="floating-chip bottom">
                  <i class="bi bi-moon-stars text-primary"></i> silencio,
          ...
          <div class="row align-items-end mb-4 gy-3">
            <div class="col-lg-8 reveal">
              <span class="section-badge mb-3"
                ><i class="bi bi-lightning-charge"></i> Artículos
                destacados</span
              >
              <h2 class="section-title mb-3">
                Lecturas que cruzan mente, símbolo y universo interior.
              </h2>
              <p class="section-lead mb-0">
                Una selección editorial para entrar por intuición, curiosidad o
                una pregunta que todavía no tiene nombre.
              </p>
            </div>
          ...
          <div class="row g-4">
            <div class="col-lg-7 reveal">
              <article class="post-card h-100 overflow-hidden">
                <img
                  src="assets/img/conciencia.png"
                  alt="Imagen abstracta sobre equilibrio interior"
                  class="img-fluid post-image"
                  loading="lazy"
                />
                <div class="p-4 p-md-5">
                  <span class="badge text-bg-primary mb-3">Conciencia</span>
                  <p class="text-secondary small mb-2">
                    <i class="bi bi-calendar3"></i> 31 de mayo de 2026
                  </p>
                  <h3 class="h2">
                    ¿Qué ocurre cuando la mente deja de buscar respuestas y
                    comienza a observarse?
                  </h3>
                  <p class="text-secondary">
                    Un ensayo visual sobre percepción, silencio mental y la
                    sensación de mirar hacia dentro como si el pensamiento
      ...
      <section class="section-padding">
        <div class="container">
          <div class="row mb-4">
            <div class="col-lg-8 reveal">
              <span class="section-badge mb-3"
                ><i class="bi bi-grid-3x3-gap"></i> Categorías</span
              >
              <h2 class="section-title mb-3">
                Temas para navegar la mente desde distintas puertas.
              </h2>
            </div>
          </div>
          <div class="row g-4">
        ...
        <div class="container">
          <div class="row g-4 align-items-center">
            <div class="col-lg-6 reveal">
              <div class="article-shell p-4 p-md-5">
                <span class="section-badge mb-3"
                  ><i class="bi bi-sparkles"></i> Filosofía de Psymind</span
                >
                <h2 class="section-title mb-3">
                  Pensar la mente como una frontera entre la emoción y el
                  cosmos.
                </h2>
                <p class="section-lead mb-0">
                  Este espacio nace para mirar lo humano desde la curiosidad:
                  sin fórmulas rígidas, sin solemnidad vacía y con la calma de
                  quien observa una constelación por primera vez.
                </p>
              </div>
            </div>
            <div class="col-lg-6 reveal">
              <div class="hero-card p-4 p-md-5">
                <img
                  src="assets/img/horus.png"
                  alt="Ilustración abstracta de una constelación de ideas"
